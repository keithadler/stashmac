...
enum TestKit {
    static var suites: [TestSuite] { [KeySuite.suite, ChunkSuite.suite, BackupSuite.suite, StoreSuite.suite, PruneSuite.suite, RetentionSuite.suite, SchedulerSuite.suite] }
